...
const CUSTOM_TOOL_DESCRIPTION_FILE = "tool-description.md";
const LEGACY_CUSTOM_TOOL_DESCRIPTION_FILE = "subagent-tool-description.md";
...
function customDescriptionPaths(options?: ToolDescriptionOptions): string[] {
	...
	return [
		path.join(getProjectConfigDir(cwd), LEGACY_CUSTOM_TOOL_DESCRIPTION_FILE),
		path.join(agentDir, "extensions", "subagents", CUSTOM_TOOL_DESCRIPTION_FILE),
		path.join(agentDir, LEGACY_CUSTOM_TOOL_DESCRIPTION_FILE),
	];
}
